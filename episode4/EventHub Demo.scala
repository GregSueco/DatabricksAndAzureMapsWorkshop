...
val SharedAccessKeyName= ["SharedAccessKeyName"]
val sasKey = ["sasKey"]
val connStr = "Endpoint=sb://["namespaceName"].servicebus.windows.net/;SharedAccessKeyName=["SharedAccessKeyName"];SharedAccessKey=["SharedAccessKeyName"]"
